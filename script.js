...
const CONFIG = {
  ...
  groomNameAr: "مينا",
  brideNameAr: "مادونا",
  weddingDate: "September 13, 2026",
  weddingDateAr: "١٣ سبتمبر ٢٠٢٦",
  weddingTime: "7:00 PM",
  weddingLocation: "La Vida Hall , Dar Al Markabat, Salah Salem Road",
  weddingLocationAr: "قاعة لاڤيدا , دار المركبات، صلاح سالم",
  weddingMapLink: "https://maps.app.goo.gl/yTRyebtcCzsUnptF6?g_st=iw",

  // --- Church Info ---
  churchName: "St. Mary & St. Bishoy Church",
  churchNameAr:
    "كنيسة العذراء مريم والأنبا بيشوي - الكاتدرائية المرقسية بالعباسية",
  churchDate: "September 13, 2026",
  churchDateAr: "١٣ سبتمبر ٢٠٢٦",
  churchTime: "5:00 PM",
  // churchLocation: "Talkha, Mansoura, Egypt",
  // churchLocationAr: "طلخا، المنصورة، مصر",
  churchMapLink: "https://maps.app.goo.gl/Av4GQYRGzsjswWrt5?g_st=iw",

  // --- WhatsApp Numbers (for RSVP) ---
  groomWhatsapp: "201201086024",
  brideWhatsapp: "201210386954",
...
function injectContent() {
  ...
  document
    .querySelectorAll(".church-date-en")
    .forEach((el) => (el.textContent = CONFIG.churchDate));
  document
    .querySelectorAll(".church-date-ar")
    .forEach((el) => (el.textContent = CONFIG.churchDateAr));
  document
